sap.ui.jsview("com.vikalp.dealermgmt.view.accounts.AccountOrderCart", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf view.accounts.AccountOrderCart
	*/ 
	getControllerName : function() {
		return "com.vikalp.dealermgmt.view.accounts.AccountOrderCart";
	},
...
//          breakpointM: 40
		...
		var accCartForm = new sap.ui.layout.form.Form("accCartForm",{
				...
				new sap.ui.layout.form.FormContainer({
					...
					formElements: [
						new sap.ui.layout.form.FormElement({
								label: "Customer",
							fields: [new sap.m.Text("accCartCustomer",{text:"{/datacon1/0/Customer}"})]
							
						}),
						new sap.ui.layout.form.FormElement({
							label: "Requested Delivery",
							fields: [new sap.m.DatePicker("accCartDate",{
...
//	 cartList.bindAggregation("items","/datacon1",cartListItem);
	     ...
	     var accCartTable = new sap.m.Table({
...
//	  	    	  debugger;
		  	         ...
		  	         var obj = accCartTable.getModel().getProperty(path);
		  	         console.log(obj); 
		  	        var hj= accCartTable.getModel()
		  	        hj.getData().accdatacon1.splice(parseInt(path.substring(10)),1);
//		  	         cartTable.removeItem(e.getParameter('listItem'));
		  	         hj.refresh(true);
//		  	       var tab2 = sap.ui.getCore().byId("cartTable");
					  var co = accCartTable.getItems().length;
					  accCartTable.setHeaderText("Items ("+co+")");
					  sap.ui.getCore().byId("acccnt1").setText(co);
//					  
	     ...
	     var    accCartTemplate = new sap.m.ColumnListItem({
                       ...
                       textAlign :"Left",
	                	 editable : true,
	            	      ...
	            	      new sap.m.DatePicker({
                   	     ...
                   	     accCartTable.bindAggregation("items","/accdatacon1",accCartTemplate); 
...
//	                  app.back();
				 ...
				 router.navTo("AccountOrderDetail");
	                  },
//			
