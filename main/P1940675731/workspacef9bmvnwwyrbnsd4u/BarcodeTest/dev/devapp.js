jQuery.sap.declare("BarcodeTest.dev.devapp");
jQuery.sap.require("BarcodeTest.dev.devlogon");

BarcodeTest.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = BarcodeTest.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new BarcodeTest.dev.devlogon();
