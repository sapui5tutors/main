jQuery.sap.require("BarcodeTest.util.Formatter");
jQuery.sap.require("BarcodeTest.util.Controller");

BarcodeTest.util.Controller.extend("BarcodeTest.view.Master", {
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "BarcodeTest.view.Detail",
			targetViewType: "XML"
		});
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("CustomerID", sap.ui.model.FilterOperator.Contains, searchString)];
		}
		 var loFilters = new sap.ui.model.Filter(filters, false);
		// update list binding
		var loBinding = this.getView().byId("list").getBinding("items");
