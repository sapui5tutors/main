...
BarcodeTest.util.Controller.extend("BarcodeTest.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			var loForm = this.getView().byId("idSmipleForm");
			loForm.bindElement(sEntityPath);

			var oIconTabBar = oView.byId("idIconTabBar");
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(BarcodeTest.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "BarcodeTest.view.NotFound",
			targetViewType: "XML"
		});
	},
