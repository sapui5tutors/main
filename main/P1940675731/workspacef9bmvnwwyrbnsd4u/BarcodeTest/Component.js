jQuery.sap.declare("BarcodeTest.Component");
jQuery.sap.require("BarcodeTest.dev.devapp");
jQuery.sap.require("BarcodeTest.MyRouter");

sap.ui.core.UIComponent.extend("BarcodeTest.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		routing: {
			config: {
				routerClass: BarcodeTest.MyRouter,
				viewType: "XML",
				viewPath: "BarcodeTest.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("BarcodeTest");
		...
		var oModel;
		var externalURL = BarcodeTest.dev.devapp.externalURL;
		var appContext;
		if (BarcodeTest.dev.devapp.devLogon) {
			appContext = BarcodeTest.dev.devapp.devLogon.appContext;
		}
